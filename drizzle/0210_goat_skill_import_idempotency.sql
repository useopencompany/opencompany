...
ALTER TABLE "goat"."knowledge_command_idempotency"
  ...
  CHECK ("goat"."knowledge_command_idempotency"."operation" IN ('brain_document.create', 'brain_asset.create', 'brain_asset.replace', 'wiki_page.create', 'wiki_timeline.create', 'skill.create', 'skill.import'));
