ALTER TABLE "goat"."workflows" ADD COLUMN "automation_triggers" jsonb DEFAULT '[]'::jsonb NOT NULL;--> statement-breakpoint
...
ALTER TABLE "goat"."workflow_schedule_runs" ADD COLUMN "trigger_id" text DEFAULT 'legacy' NOT NULL;--> statement-breakpoint
...
ALTER TABLE "goat"."workflow_event_runs" ADD COLUMN "trigger_id" text DEFAULT 'legacy' NOT NULL;--> statement-breakpoint
...
ALTER TABLE "goat"."workflow_read_model_v1" ADD COLUMN "triggers" jsonb DEFAULT '[]'::jsonb NOT NULL;--> statement-breakpoint
ALTER TABLE "goat"."workflow_read_model_v1" ADD COLUMN "created_by_workos_id" text;--> statement-breakpoint
...
BEGIN
  ...
  INSERT INTO goat.workflow_read_model_v1 (
    id, workspace_id, slug, name, description, steps, status, trigger, triggers,
    created_by_workos_id, schedule_cron, schedule_timezone, schedule_prompt, schedule_enabled,
    ...
    END,
    projected_triggers, NEW.created_by_workos_id, NEW.schedule_cron, NEW.schedule_timezone,
