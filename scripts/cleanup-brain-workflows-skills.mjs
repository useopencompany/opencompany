...
//
// Run this ONLY after goat-backfill-workflows-skills.ts has run and been verified
...
//
// Usage: DATABASE_URL=postgres://... node scripts/goat-cleanup-brain-workflows-skills.mjs
