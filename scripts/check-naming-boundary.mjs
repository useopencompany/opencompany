...
const protectedCompatibilityTokens = [
  ...
  // 1197 = 1192 + the harness check on goat.codex_chat_sessions and the four constraint and index
  // names on goat.imessage_bindings.
  ["physical and stored quoted goat_* identifiers", /["'`]goat_[a-z0-9_]*["'`]/gu, 1197],
