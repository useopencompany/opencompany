...
const protectedCompatibilityTokens = [
  // 1177 = 1168 + the queued run, turn, and conversation ids in the coding-chat steering tests.
  ["physical and stored quoted goat_* identifiers", /["'`]goat_[a-z0-9_]*["'`]/gu, 1177],
