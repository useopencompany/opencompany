...
const groups = {
  goat: {
    ...
    required: [
      ...
      "AUTHKIT_DOMAIN",
      "MACOS_OAUTH_AUDIENCE",
      "MACOS_OAUTH_CLIENT_ID",
    ...
    optional: [
      ...
      "CHAT_ACTIONS_KILL_SWITCH",
      "CHAT_SANDBOX_IMAGE",
      "LINQ_API_TOKEN",
      "LINQ_FROM_NUMBER",
      "LINQ_API_BASE_URL",
      "IMESSAGE_PROVIDER",
      "IMESSAGE_KILL_SWITCH",
      "IMESSAGE_DAILY_CAP",
      "MANAGED_CAPABILITIES_KILL_SWITCH",
      "DISABLED_MANAGED_CAPABILITY_ACTIONS",
      "LATITUDE_API_KEY",
  ...
  runner: {
    ...
    optional: [
      ...
      "DICTATION_REALTIME_MODEL",
      "DICTATION_FINAL_MODEL",
