...
| `moonshotai/kimi-k3`                       | Flagship Kimi for long-horizon coding and knowledge work.       |
| `moonshotai/kimi-k2.6`                     | Cost-conscious Kimi for long-horizon coding and agent workflows. |
...
| `x` | Scrape public X posts, profiles, timelines, and discussions through Apify. |
