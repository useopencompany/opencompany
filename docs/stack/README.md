...
| Product | Next.js, React | Goat UI, API routes, auth callbacks, webhooks |
...
| Hosting | Vercel, Render | Goat/marketing and runner respectively |
...
Goat execution paths are documented in [the Goat system map](../../apps/goat/docs/README.md).
