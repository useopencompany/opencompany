...
| `INTEGRATION_CREDENTIAL_ENCRYPTION_KEY` | Yes | Same base64-encoded 32-byte key used by web and runner. Encrypts Goat OAuth and provider credentials, including Stripe access and refresh tokens. |
