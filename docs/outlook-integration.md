...
Migration `0265_outlook_integrations.sql` adds the two providers to the three vault constraints.
...
is safe. Production migration execution belongs to the normal release process.
