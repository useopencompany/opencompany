...
export const FRESHNESS_VALUES = ["fresh", "aging", "stale"] as const;
export type MemoryFreshness = (typeof FRESHNESS_VALUES)[number];
...
const FRESHNESS_SET = new Set<string>(FRESHNESS_VALUES);
...
export function isMemoryFreshness(value: unknown): value is MemoryFreshness {
