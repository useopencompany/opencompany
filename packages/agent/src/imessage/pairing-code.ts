...
export function hashImessagePairingCode(input: PairingCodeHashInput): string {
...
export function verifyImessagePairingCode(input: PairingCodeVerifyInput): boolean {
  const actual = Buffer.from(hashImessagePairingCode(input), "utf8");
