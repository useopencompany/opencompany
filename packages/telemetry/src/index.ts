...
export const METRICS = {
  ...
  chatModelFirstChunkDurationMs: "goat.chat.model_first_chunk_duration_ms",
  chatModelStepDurationMs: "goat.chat.model_step_duration_ms",
  chatModelTimeoutsTotal: "goat.chat.model_timeouts_total",
  chatPartialRecoveriesTotal: "goat.chat.partial_recoveries_total",
...
export type SpanHandle = {
  ...
  fail(error: unknown, attributes?: TelemetryAttributes): FailureCategory;
...
export function sanitizeAttributes(attributes: TelemetryAttributes | undefined): OtelAttributes {
...
export function startSpan(name: string, attributes?: TelemetryAttributes): SpanHandle {
...
export function recordCounter(name: string, value = 1, attributes?: TelemetryAttributes) {
...
export function recordSignup(
  input: { source?: SignupSource; attributes?: TelemetryAttributes } = {},
) {
