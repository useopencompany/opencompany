...
export const goatIntegrations = goat.table(
  ...
  (table) => ({
    ...
    providerCheck: check(
      ...
      sql`${table.provider} IN ('gmail', 'google_calendar', 'google_drive', 'linear', 'github', 'jamie', 'slack', 'slack_bot', 'granola')`,
    ),
    statusCheck: check(
...
export const goatBrainSources = goat.table(
  ...
  (table) => ({
    ...
    providerCheck: check(
      ...
      sql`${table.provider} IN ('jamie', 'gmail', 'google_drive', 'github', 'slack', 'linear', 'slack_bot', 'granola')`,
    ),
  }),
);
