...
// scripts/goat-migrate-brain-to-wiki.ts applies a plan; everything here is
...
export const WIKI_MIGRATION_KIND_BY_ENTITY_TYPE: Record<GoatBrainEntityType, GoatWikiKind> = {
  person: "person",
  company: "company",
  project: "project",
  meeting: "meeting",
...
export type WikiMigrationSourceDocument = {
  ...
  format: GoatBrainDocumentFormat;
