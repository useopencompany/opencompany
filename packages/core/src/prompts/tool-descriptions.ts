...
export const DELETE_TASK_SCHEDULE_TOOL_DESCRIPTION =
  "Delete an existing recurring task schedule so it no longer creates future task runs. Already-created queued or running task runs continue.";
