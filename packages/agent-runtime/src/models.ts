...
const CODEX_SUBSCRIPTION_MODEL_IDS = [
  "openai/gpt-5.6-sol",
  "openai/gpt-5.6-terra",
] as const satisfies readonly AgentModelId[];
...
export const AGENT_MODEL_CATALOG: AgentModelDefinition[] = [
  ...
  },
  {
    ...
    label: "Kimi K3",
    description: "Flagship Kimi model for long-horizon coding, deep reasoning, and knowledge work.",
    category: "Deep",
    supportsReasoning: true,
    supportsImages: true,
    supportsPdf: false,
  ...
  },
  {
    ...
    contextWindowTokens: 256_000,
    label: "Kimi K2.6",
    description: "Kimi model for cost-conscious long-horizon coding and agent workflows.",
    category: "Deep",
    supportsReasoning: true,
    supportsImages: false,
    supportsPdf: false,
