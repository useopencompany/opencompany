...
export const MEMORY_KEEPER_SYSTEM_PROMPT = [
  ...
  "- `get <id> [--section truth|timeline|frontmatter|all]` — read a structured full record by default; use sections to narrow output or read the raw file. (There is no `show` command.)",
