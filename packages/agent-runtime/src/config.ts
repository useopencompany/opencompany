...
export function resolveAgentRuntimeConfig(input: {
  ...
  const context = [
    ...
    "Before saying memory does not contain a durable fact about the user, company, people, projects, or past decisions, query memory first; ask the user only after that lookup fails or the request is blocked.",
