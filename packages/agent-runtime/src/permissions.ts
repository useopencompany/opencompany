...
export const PROVIDER_PERMISSION_REGISTRY: Record<string, ProviderPermissionSpec> = {
  ...
  posthog: {
    ...
    // PostHog MCP tool names are hyphenated (e.g. "feature-flag-get-all"). Anything
    // not listed falls back to the verb heuristic. Refine against the live tool list.
    toolGroups: {
      "get-sql-insight": "read",
      "query-run": "read",
      "insights-get-all": "read",
      "insight-get": "read",
      "dashboards-get-all": "read",
      "dashboard-get": "read",
      "feature-flag-get-all": "read",
      "feature-flag-get-definition": "read",
      "experiment-get-all": "read",
      "list-errors": "read",
      "error-details": "read",
      "docs-search": "read",
      "organizations-get": "read",
      "projects-get": "read",
      "create-feature-flag": "post",
      "insight-create-from-query": "post",
      "dashboard-create": "post",
      "add-insight-to-dashboard": "post",
      "experiment-create": "post",
      "update-feature-flag": "modify",
      "insight-update": "modify",
      "dashboard-update": "modify",
      "experiment-update": "modify",
      "delete-feature-flag": "admin",
      "insight-delete": "admin",
      "dashboard-delete": "admin",
      "project-set-active": "admin",
      "organization-set-active": "admin",
    },
  },
  github: {
    providerKey: "github",
