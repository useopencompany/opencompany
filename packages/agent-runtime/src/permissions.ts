...
export const PROVIDER_PERMISSION_REGISTRY: Record<string, ProviderPermissionSpec> = {
  ...
  figma: {
    ...
    gated: true,
    permissionDescriptions: {
      read: "Read design context, variables, screenshots, libraries, and Code Connect mappings",
      post: "Create files, diagrams, generated designs, assets, or Code Connect mappings",
      modify: "Create, edit, delete, or inspect objects through the general Figma tool",
    },
    toolGroups: {
      whoami: "read",
      ...
      get_figjam: "read",
      get_libraries: "read",
      search_design_system: "read",
      get_code_connect_map: "read",
      get_code_connect_suggestions: "read",
      get_context_for_code_connect: "read",
      create_new_file: "post",
      generate_diagram: "post",
      generate_figma_design: "post",
      upload_assets: "post",
      add_code_connect_map: "post",
      send_code_connect_mappings: "post",
      use_figma: "modify",
    },
  },
  github: {
