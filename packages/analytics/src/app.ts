import { captureServerEvent } from "./shared-server";
...
export type IngestionQuotaAnalyticsUpdate = {
  workspaceId: string;
  pendingUnits: number;
  paused: boolean;
};

export function captureIngestionQuotaAnalytics(
  updates: IngestionQuotaAnalyticsUpdate[] | undefined,
) {
