...
describe("ProductAnalyticsProvider", () => {
  it("captures one explicit app event with all automatic collection disabled", async () => {
    ...
    rerender(
      <ProductAnalyticsProvider identity={{ userId: "user_123", workspaceId: "workspace_123" }}>
        <div>opencompany</div>
      </ProductAnalyticsProvider>,
    );
    ...
    rerender(
      <ProductAnalyticsProvider identity={{ userId: "user_456", workspaceId: "workspace_456" }}>
        <div>opencompany</div>
      </ProductAnalyticsProvider>,
    );
