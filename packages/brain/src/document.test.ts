...
describe("opencompany Brain document", () => {
...
`;
  ...
  it("removes a leading duplicate title heading from compiled truth", () => {
    ...
    ).toBe("Acme evaluates opencompany Brain.\n\n## Notes\nKeep this section.");
    expect(
      normalizeBrainCompiledTruth("## **Acme**\n\nAcme evaluates opencompany Brain.", "Acme"),
    ).toBe("Acme evaluates opencompany Brain.");
...
This is a user-authored Markdown note, not a full opencompany Brain document.`;
...
describe("opencompany Brain asset text block", () => {
