...
function buildIngestPrompt(input: {
  ...
  const docs = input.existing
    ...
    .join("\n");
  return [
    "You are the controlled ingestion loop for opencompany Brain, a durable graph of user-owned knowledge.",
...
function buildRepairPrompt(input: {
  ...
  return [
    "Repair the prior opencompany Brain ingest response. Return only valid JSON matching the requested shape.",
