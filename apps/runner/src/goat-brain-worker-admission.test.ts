...
import { GOAT_BRAIN_WORKER_ADMISSION_CHANNEL } from "@opencompany/db/worker-admission";
...
describe("startGoatBrainWorkerAdmissionListener", () => {
  it("routes valid durable admission hints and ignores malformed payloads", async () => {
    ...
    const listener = startGoatBrainWorkerAdmissionListener({
