...
export function buildJamieMeetingAgentIngestPrompt(
  ...
  return [
    ...
    `1. A meeting page with id "${context.meetingBrainId}" in the "${JAMIE_MEETING_FOLDER}" folder (type: note) whose compiled truth synthesizes the meeting: what it was, decisions, action items, and [[page:...]] links to every attendee and company page. Link the evidence record. Do not paste the transcript.`,
