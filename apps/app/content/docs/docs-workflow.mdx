---
title: Docs workflow
description: How to keep opencompany documentation current while the app changes.
---
...
- User-facing opencompany behavior.
- Chat or task flow.
- Runner behavior for tasks.
...
For copy-only changes, typecheck is usually enough. For route or rendering changes, open `/docs` in the app and click at least one nested docs page.
