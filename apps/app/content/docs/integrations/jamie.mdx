---
title: Jamie
description: Connect Jamie completed-meeting webhooks to Brain ingestion.
---
...
The saved Jamie API key routes the delivery to the right opencompany integration. Do not use the legacy `/api/webhooks/jamie/<integration-id>` URL for new setups.
