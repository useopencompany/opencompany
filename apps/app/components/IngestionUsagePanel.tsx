import type { SpendBreakdownRow } from "@opencompany/db/credits";
...
const CATEGORY_LABELS: Record<SpendBreakdownRow["category"], string> = {
  chat: "Chat",
  ingestion: "Ingestion",
...
function groupByDay(rows: SpendBreakdownRow[]) {
  const byDay = new Map<string, SpendBreakdownRow[]>();
