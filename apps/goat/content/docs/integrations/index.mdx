...
- **OAuth tool connectors** let Goat call a provider API on the user's behalf. Gmail, Google Calendar, Google Drive, GitHub, Linear MCP, and Slack use this shape. Main chat exposes curated actions for connected Attio, Slack, Gmail, Google Calendar, Google Drive, and Linear accounts. Linear can create and update issues and add comments; Calendar can create events. These writes require confirmation by default.
