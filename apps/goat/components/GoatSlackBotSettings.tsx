...
import { disconnectGoatSlackBotAction } from "@/lib/slack-bot-actions";

export type GoatSlackBotSettingsData = {
  isAdmin: boolean;
  configured: boolean;
  installed: boolean;
...
export function GoatSlackBotSettings({ data }: { data: GoatSlackBotSettingsData }) {
  return (
    <GoatSettingsContent
      title="Slack bot"
...
function SlackBotPanel({ data }: { data: GoatSlackBotSettingsData }) {
