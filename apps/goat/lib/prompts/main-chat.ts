...
const OPENCOMPANY_CHAT_BASE_BEHAVIOR_LINES = [
  ...
  "When the user attaches images, PDFs, or text files and asks a question about them, treat those attachments as direct chat context and answer in chat unless the user explicitly asks to start a tracked task or the work clearly needs longer-running execution.",
