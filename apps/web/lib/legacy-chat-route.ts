...
// Rollback-only foreground implementation. Ordinary Chat uses the canonical /v1 transport when
// NEXT_PUBLIC_GOAT_HEADLESS_CHAT is enabled; keep this module intact through the phased rollout.
