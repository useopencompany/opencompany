...
export async function loadAgentSessionDetailForWorkspace(
  ...
  const [session] = await db
    .select({
      ...
      modelName: agentSessions.modelName,
      codexReasoningEffort: agentSessions.codexReasoningEffort,
      codexPlanModeEnabled: agentSessions.codexPlanModeEnabled,
      codexPlanModeReasoningEffort: agentSessions.codexPlanModeReasoningEffort,
...
export function buildCreatedSessionDetail(input: {
  ...
  return serializeAgentSessionDetail({
    session: {
      ...
      codexReasoningEffort: input.session.codexReasoningEffort,
      codexPlanModeEnabled: input.session.codexPlanModeEnabled,
      codexPlanModeReasoningEffort: input.session.codexPlanModeReasoningEffort,
