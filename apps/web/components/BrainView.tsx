...
import { normalizeBrainCompiledTruth } from "@opencompany/brain/document";
import {
...
import { isBrainSkillFolder } from "@opencompany/brain/skills";
...
function BrainEditor({
  ...
  const submitFileDialog = (fileName: string) => {
    ...
    startCreateTransition(async () => {
      let createdDocument: BrainDocumentView;
      try {
...
function documentEditorBody(document: BrainDocumentView | null | undefined) {
  if (!document) return "";
  return normalizeBrainCompiledTruth(document.body, document.title);
}
