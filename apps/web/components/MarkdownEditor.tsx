...
export function MarkdownEditor({
  ...
  readOnly?: boolean;
  // Handle an internal wiki href client-side. Return true if handled; when
  ...
  // (e.g. workflow/skill instructions) instead of a full wiki page.
  compact?: boolean;
  placeholder?: string;
  ...
  const editor = useEditor(
    {
      ...
      editorProps: {
        attributes: {
          class: compact
            ? "tiptap-doc tiptap-doc-compact min-h-[220px] w-full text-[13.5px] leading-6 text-ink outline-none"
            : "tiptap-doc min-h-[560px] w-full pb-20 text-[15px] leading-7 text-ink outline-none",
        },
      },
      onUpdate: ({ editor }) => {
  ...
  }, [pageLinks, editor, navigateInternal, pageTitles, readOnly]);
