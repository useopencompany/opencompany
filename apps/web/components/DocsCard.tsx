...
export function DocsCard({ href, title, description }: DocsCardProps) {
  return (
    <Link
      href={href}
      className="group flex flex-col gap-1.5 rounded-xl border border-[#e6e6e3] bg-white/60 p-5 transition-all duration-150 hover:border-[#d4d4cf] hover:bg-white/90 hover:shadow-[0_2px_8px_rgba(0,0,0,0.05)]"
    >
