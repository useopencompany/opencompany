...
vi.mock("@/lib/billing/actions", () => ({
  ...
  createCreditTopUpAction: vi.fn(),
  createProCheckoutAction: vi.fn(),
  setAutoRefillAction: vi.fn(),
}));

const base: BillingPanelData = {
  plan: "hobby",
...
describe("BillingPanel", () => {
  ...
  it("offers Pro to admins and shows the active team plan", () => {
    const { rerender } = render(
      <BillingPanel data={base} checkoutResult={null} topupResult={null} />,
    );
