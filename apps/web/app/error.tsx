  ...
  return (
    <main className="flex min-h-dvh items-center justify-center bg-canvas px-6 text-ink">
      <div className="max-w-sm text-center">
        ...
        <p className="mt-2 text-sm text-ink-muted">Please try again. We have captured the error.</p>
        <button
          type="button"
          onClick={reset}
          className="mt-5 rounded-md bg-ink px-4 py-2 text-sm font-medium text-canvas"
        >
          Try again
        </button>
      </div>
