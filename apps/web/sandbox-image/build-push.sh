...
IMAGE_REF="${GOAT_CHAT_SANDBOX_IMAGE_REF:-}"

if [[ -z "$IMAGE_REF" ]]; then
  : "${VERCEL_TEAM_SLUG:?Set VERCEL_TEAM_SLUG or GOAT_CHAT_SANDBOX_IMAGE_REF.}"
  : "${VERCEL_PROJECT_SLUG:?Set VERCEL_PROJECT_SLUG or GOAT_CHAT_SANDBOX_IMAGE_REF.}"
